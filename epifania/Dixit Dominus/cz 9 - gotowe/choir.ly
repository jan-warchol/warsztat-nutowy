...
scripture = \markup { \column \right-align { "nuty przepisane przez Basię Mroczek"} }

translation = \markup {
  \typewriter {
    \column {
      \vspace #1
      \bold "De torrénte   in vía    bíbet:      proptérea exaltábit cáput."
            "Ze strumienia po drodze będzie pił, dlatego   podniesie głowę."
    }
  }
}
