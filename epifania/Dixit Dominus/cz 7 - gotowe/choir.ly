...
scripture = \markup { \column \right-align { "nuty przepisane przez" "Krysię Mazur i Dominikę Kochanowską" " "} }

translation = \markup {
  \typewriter {
    \column {
      \vspace #1
      \bold "Judicábit     in     natiónibus, implébit ruínas:"
            "Będzie sądził między narodami,   wzniesie ruiny:"
    }
  }
}
