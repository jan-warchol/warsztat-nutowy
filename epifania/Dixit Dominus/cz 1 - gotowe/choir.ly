...
translation = \markup {
  \typewriter {
    \column {
      \vspace #1
      \bold "Díxit Dóminus    Dómino méo:  Séde  a  déxtris méis,"
            "Rzekł Pan     do Pana   mego: Siądź po prawicy mojej,"
      " "
      \bold "Donec pónam   inimícos      túos,  scabéllum  pédum tuórum."
            "Aż    uczynię nieprzyjaciół twoich podnóżkiem stóp  twoich."
    }
  }
}
