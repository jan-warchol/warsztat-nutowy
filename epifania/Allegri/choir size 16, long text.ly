...
\bookOutputSuffix "size 16, block"

scripture = \markup { \column { "Ps 51 (50)" " " } }

translation = \markup \fontsize #-3.5 {
    \typewriter {
...
individualBreaks = {
            \repeat unfold 6 { s1*2 \noBreak } \break \parenthesizedchoirI \repeat unfold 6 { s1*2 \noBreak } \break  s1*2*2 \break   
    \choirII \repeat unfold 7 { s1*2 \noBreak } \break \repeat unfold 7 { s1*2 \noBreak } \break  s1*2*2  \break 
    \choirI \repeat unfold 5 { s1*2 \noBreak } \break \repeat unfold 7 { s1*2 \noBreak } \break  s1*2*2 \break   
    \choirII \repeat unfold 6 { s1*2 \noBreak } \break \repeat unfold 7 { s1*2 \noBreak } \break  s1*2*2  \break
    \choirI \repeat unfold 5 { s1*2 \noBreak } \break \repeat unfold 7 { s1*2 \noBreak } \break  s1*2*2 \break   
    \choirII \repeat unfold 6 { s1*2 \noBreak } \break \repeat unfold 7 { s1*2 \noBreak } \break  s1*2*2  \break
    \choirI \repeat unfold 5 { s1*2 \noBreak } \break \repeat unfold 7 { s1*2 \noBreak } \break  s1*2*2 \break   
    \choirII \repeat unfold 6 { s1*2 \noBreak } \break \repeat unfold 7 { s1*2 \noBreak } \break  s1*2*2  \break
    \choirI s1*2*4 s1 \break s1 \repeat unfold 7 { s1*2 \noBreak } \break  s1*2*2 \break   
    \choirII \repeat unfold 6 { s1*2 \noBreak } \break \repeat unfold 7 { s1*2 \noBreak } \break 
    \choirI \repeat unfold 5 { s1*2 \noBreak } \break 
  }
